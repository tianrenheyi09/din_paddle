...
def network(item_count, cat_count, max_len):
    ...
    print("hist_item_emb", hist_item_emb.shape)
    print("hist_cat_emb", hist_cat_emb.shape)
    hist_seq_concat = fluid.layers.concat([hist_item_emb, hist_cat_emb], axis=2)
    print("target_item_seq_emb", hist_cat_emb.shape)
    print("target_cat_seq_emb", hist_cat_emb.shape)
    target_seq_concat = fluid.layers.concat(
        [target_item_seq_emb, target_cat_seq_emb], axis=2)

    print("target_item_emb", target_item_emb.shape)
    print("target_cat_emb", target_cat_emb.shape)
    target_concat = fluid.layers.concat(
        [target_item_emb, target_cat_emb], axis=1)

    print("hist_seq_concat", hist_seq_concat.shape)
    print("target_seq_concat", target_seq_concat.shape)
